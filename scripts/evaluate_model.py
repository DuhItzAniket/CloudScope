...
checkpoint_path = r'C:\Users\Luikz\Downloads\CloudScope\models\cloudscope_efficientnet_b0_best.pth'
img_size = 224
batch_size = 32
...
metrics = {
    'model': 'efficientnet_b0_advanced',
...
with open(os.path.join(results_dir, 'metrics_advanced_effnetb0.json'), 'w') as f:
